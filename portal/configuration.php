...
class JConfig {
	...
	public $user = 'i795136_jos1';                       // DB username
	public $password = 'K@LKT8DsFGNoBn[VdJ*38~]0';                   // DB password
	public $db = 'i795136_jos1';                         // DB database name
	public $dbprefix = 'jos_';               // Do not change unless you need to!

	/* Server Settings */
	public $secret = 'GZRPY2jdjseJFFa2';     // Change this to something more secure
	public $gzip = '0';
	...
	public $ftp_enable = '';
	public $tmp_path = '/home/shaantaneja/public_html/MYSITES/j-zeeautoservice.com/portal/tmp';                // Please check with your host that this is the correct path to the temp directory. This path needs to be writable by Joomla!
	public $log_path = '/home/shaantaneja/public_html/MYSITES/j-zeeautoservice.com/portal/logs';           // Please check with your host that this is the correct path to the logs directory. This path needs to be writable by Joomla!
	...
	/* Mail Settings */
	public $mailer = 'mail';
	public $mailfrom = 'shaantaneja@p3plcpnl0543.prod.phx3.secureserver.net';
